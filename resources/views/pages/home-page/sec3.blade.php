<div class="sec3-hp-pc d-none d-sm-block">
    <div class="row-test">
        ...
        <div class="col-12 row-test">
            <img src="{{asset('images/homepage/sec3/Group 83.png')}}" class="col-xl-3 col-md-4 left-img-sec3-hp">
            <img src="{{asset('images/homepage/sec3/Group 78.png')}}" class="col-xl-3 col-md-4 mid-img-sec3-hp">
            <img src="{{asset('images/homepage/sec3/Group 77.png')}}" class="col-xl-3 col-md-4 right-img-sec3-hp">
        </div>
        <div class="col-12 row-test">
            <img src="{{asset('images/homepage/sec3/Group 82.png')}}" class="col-xl-3 col-md-4 left-img-sec3-hp">
            <img src="{{asset('images/homepage/sec3/Group 79.png')}}" class="col-xl-3 col-md-4 mid-img-sec3-hp">
            <img src="{{asset('images/homepage/sec3/Group 76.png')}}" class="col-xl-3 col-md-4 right-img-sec3-hp">
        </div>
        <div class="col-12 row-test">
