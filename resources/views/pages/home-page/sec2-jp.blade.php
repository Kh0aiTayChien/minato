<div class="sec2-HP-pc d-none d-sm-block">
    <p class="header-first-line-hp-1 co-header-css mulish-extrabold space-21" data-aos="fade-right"
       data-aos-duration="3000">The Minato Residence</p>
    <p class="header-second-line-hp-1 co-header-css icielbegum space-51" data-aos="fade-left" data-aos-duration="3000"
       style="text-transform: uppercase">日本の真髄を港町ハイフォンに</p>
    {{--    <p class="header-second-line-hp-1 co-header-css icielbegum space-51" data-aos="fade-right"--}}
    {{--       data-aos-duration="3000">{{ __('homepage/section2.mainTitle2') }}</p>--}}
    <div class="row-test-1">
        <div class="left-test-1" style="padding-left: 4%; padding-top: 4%">
            <p class="first-text-hp text-content1-sec2-hp space-15 text-hp cabin-medium pb-4" data-aos="fade-right"
               data-aos-duration="3000">
                日本のライフスタイルを目指して、THE MINATO RESIDENCEが誕生。ラックチャイ川を見渡すここには、利便性と自然環境が調和し、ここに住まう歓びを穏やかに感じられる空気感が満ちています。
            </p>
            <a href="{{route('introduce.index')}}" class="double-border first-text-hp px-3 mulish-black space-21-btn"
               data-aos="fade-up" data-aos-duration="3000">
                もっと見る
            </a>
        </div>
        <img src="{{asset('images/homepage/sec2/21321-01.jpg')}}" class="img-sec2-hp-1 right-test-1"
...
{{--            <p class="header-second-line-hp header-content2-sec2-hp icielbegum space-51">{{ __('homepage/section2.mainTitle6') }}</p>--}}
            <p class="header-second-line-hp header-content2-sec2-hp icielbegum space-51"
               style="line-height: 60px">豊かな水資源に囲まれた場所
            </p>
            <div class="d-block" style="width: 20vw; padding-top: 2%; padding-bottom: 2%">
                <p class="text-hp text1-content2-sec2-hp cabin-medium space-15">
                    その美しさから愛されるラックチャイ川のほとり、ハイフォン市の新興エリア「ウォーターフロントシティ」の中心に位置。多種多様な飲食店、ショッピングはもちろん、寛ぎや散歩の時間も優雅に愉しめます。
                </p>
            </div>
            <div class="btn-content2-sec2-hp">
                <a href="{{route('location.index')}}"
                   class="btn-content2-sec2-hp double-border px-3 mulish-black space-21-btn">もっと見る
                </a>
            </div>
        </div>
    </div>
...
<div class="sec2-hp-mb d-block d-sm-none">
    ...
    <p class="header-second-line-hp-mb icielbegum"
       style="font-size: 29px; text-transform: uppercase; line-height: 30px">日本の真髄を港町ハイフォンに
    </p>
{{--    <p class="header-second-line-hp-mb line-height-cap icielbegum" style="">{{ __('homepage/section2.mainTitle2') }}</p>--}}
    <p class="text-hp-mb cabin-medium mt-4">日本のライフスタイルを目指して、THE MINATO RESIDENCEが誕生。ラックチャイ川を見渡すここには、利便性と自然環境が調和し、ここに住まう歓びを穏やかに感じられる空気感が満ちています。
    </p>
    ...
    <p class="header-second-line-hp-mb icielbegum"
       style="font-size: 29px; text-transform: uppercase; line-height: 30px">豊かな水資源に囲まれた場所
    </p>
{{--    <p class="header-second-line-hp-mb line-height-cap icielbegum"--}}
{{--       style="font-size: 29px; text-transform: uppercase">{{ __('homepage/section2.mainTitlem5') }}</p>--}}
    <p class="text-hp-mb cabin-medium mt-4">その美しさから愛されるラックチャイ川のほとり、ハイフォン市の新興エリア「ウォーターフロントシティ」の中心に位置。多種多様な飲食店、ショッピングはもちろん、寛ぎや散歩の時間も優雅に愉しめます。
    </p>
