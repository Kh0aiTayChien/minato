<div class="sec2-HP-pc d-none d-sm-block">
    ...
    <div class="row-test">
        <div class="col-md-4" style="padding-left: 4%">
            ...
            <p class="first-text-hp space-15 text-hp cabin-medium pb-4">Tiên phong mang đến một làn gió mới về phong
            ...
            <a href="{{route('introduce.index')}}" class="double-border first-text-hp px-4 py-2 mulish-black space-21">
                TÌM HIỂU THÊM
            </a>
        </div>
        <img src="{{asset('images/homepage/sec2/Mask group (3).png')}}" class="col-md-8 img-sec2-hp-1">
    </div>
    <br>
    <div class="row-test">
        <img src="{{asset('images/homepage/sec2/image 6.png')}}" class="col-md-8 img-sec2-hp-2">
        <div class="col-md-4" style="padding-right: 4%">
            ...
            <p class="text-hp text1-content2-sec2-hp cabin-medium space-15">The Minato Residence tọa lạc bên bờ sông
            ...
            <p class="text-hp cabin-medium pb-4 space-15">Nằm tại lõi trung tâm mới của thành phố Hải Phòng, The Minato
            ...
            <div class="btn-content2-sec2-hp">
                <a href="{{route('location.index')}}"
                   class="btn-content2-sec2-hp double-border px-5 py-2 mulish-black space-21">TÌM HIỂU THÊM</a>
            </div>
        </div>
    </div>
</div>
