<div class="sec2-HP-pc d-none d-sm-block">
    ...
    <p class="header-second-line-hp-1 co-header-css icielbegum space-51" data-aos="fade-left" data-aos-duration="3000">{{ __('homepage/section2.mainTitle1') }}</p>
    ...
    <div class="row-test" style="padding-top: 2%">
        ...
        <div class="d-block" style="" data-aos="fade-left" data-aos-duration="3000">
            ...
            <p class="header-second-line-hp header-content2-sec2-hp icielbegum space-51">{{ __('homepage/section2.mainTitle7') }}</p>
...
<div class="sec2-hp-mb d-block d-sm-none">
    ...
    <p class="header-second-line-hp-mb line-height-cap icielbegum" style="font-size: 29px">{{ __('homepage/section2.mainTitle1') }}</p>
    <p class="header-second-line-hp-mb line-height-cap icielbegum">{{ __('homepage/section2.mainTitle2') }}</p>
