<div class="sec2-HP-pc d-none d-sm-block">
    <p class="header-first-line-hp co-header-css mulish-extrabold space-21">The Minato Residence</p>
    <p class="header-second-line-hp co-header-css icielbegum space-51">TINH HOA NHẬT BẢN</p>
    <p class="header-second-line-hp co-header-css icielbegum space-51">An yên giữa lòng phố Cảng</p><br>
    <div class="row-test">
        <div class="col-md-3">
            <p class="first-text-hp space-15 text-hp cabin-medium pb-4">Tiên phong mang đến một làn gió mới về phong cách sống và đẳng cấp từ Nhật
                Bản, The Minato
            ...
            <a href="{{route('introduce.index')}}" class="double-border first-text-hp px-5 py-2 mulish-black space-21">
                TÌM HIỂU THÊM
            </a>
        </div>
    ...
    <div class="row-test">
        ...
        <div class="col-md-3 col-xl-3">
            <p class="header-first-line-hp space-21 header-content2-sec2-hp mulish-extrabold">vị trí dự án</p>
            ...
            <p class="header-second-line-hp header-content2-sec2-hp icielbegum space-51">ĐỊA THẾ</p>
            <p class="header-second-line-hp header-content2-sec2-hp icielbegum space-51">PHÚ QUÝ</p>
            <p class="text-hp text1-content2-sec2-hp cabin-medium space-15">The Minato Residence tọa lạc bên bờ sông Lạch Tray thơ mộng, thừa
            ...
            <p class="text-hp cabin-medium pb-4 space-15">Nằm tại lõi trung tâm mới của thành phố Hải Phòng, The Minato Residence là tâm điểm giao
                thoa
            ...
            <div class="btn-content2-sec2-hp">
                <a href="{{route('location.index')}}" class="btn-content2-sec2-hp double-border px-5 py-2 mulish-black space-21">TÌM HIỂU THÊM</a>
            </div>
        </div>
    </div>
</div>
...
<div class="sec2-hp-mb d-block d-sm-none">
    ...
    <p class="text-hp-mb cabin-medium">The Minato Residence tọa lạc bên bờ sông Lạch Tray thơ mộng, thừa hưởng trọn vẹn lợi thế về
