    ...
    <div id="section-1-carousel" class="carousel slide w-100" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('images/homepage/section-1/can-ho-cao-cap.png')}}" class="img-slide img-fluid" alt="img-slide">
            </div>
            <div class="carousel-item">
                <img src="{{asset('images/homepage/section-1/tinh-hoa-nhat.png')}}" class="img-slide img-fluid" alt="img-slide">
            </div>
            <div class="carousel-item">
                <img src="{{asset('images/homepage/section-1/nha-chuan-nhat.png')}}" class="img-slide img-fluid" alt="img-slide">
            </div>
        </div>
