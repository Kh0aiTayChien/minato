    ...
    <div class="d-flex align-content-center justify-content-center pt-4">
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="mulish-extrabold text-white" style="font-size: 21px"> HỆ THỐNG TIỆN ÍCH</div>
            ...
            <div class="col-xs-12 col-md-6 text-white">
                ...
                <div class="mulish-extrabold " style="font-size: 21px"> hiện đại, và đẳng cấp, nơi cư dân thỏa sức trải
                    nghiệm các
                </div>
                <div class="mulish-extrabold " style="font-size: 21px"> tiện ích đẳng cấp chuẩn Nhật và môi trường thân
                    thiện
                </div>
