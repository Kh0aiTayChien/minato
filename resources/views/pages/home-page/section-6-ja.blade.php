<div class="section-6 pt-5 pb-5" >
    <div class=" d-flex justify-content-center align-items-center NotoSerifJP  px-3 d-none d-md-flex"
         style="font-size: 2.65625vw; color: #141C46; text-transform: uppercase">
        {{ __('homepage/section6.Title1')}}
    </div>
    <div class=" d-flex justify-content-center align-items-center NotoSerifJP  px-3 d-md-none text-center"
                ...
                <div id="section-tab1-carousel" class="carousel slide w-100" data-bs-ride="carousel"
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{asset('images/homepage/section-6/1-phong-ngu/1.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{asset('images/homepage/section-6/1-phong-ngu/2.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{asset('images/homepage/section-6/1-phong-ngu/3.png')}}" class="img-slide  h-100"
                                 alt="img-slide">
                        </div>
                    </div>
        ...
        <div class="row tab tab2  mt-5 gy-4 gx-0 " style="">
            <div class="section-tab d-flex justify-content-center align-items-center">
                <div id="section-tab2-carousel" class="carousel slide w-100" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{asset('images/homepage/section-6/2-phong-ngu/1.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{asset('images/homepage/section-6/2-phong-ngu/2.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{asset('images/homepage/section-6/2-phong-ngu/3.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                        <div class="carousel-item ">
                            <img src="{{asset('images/homepage/section-6/2-phong-ngu/4.png')}}" class="img-slide h-100"
                                 alt="img-slide">
                        </div>
                    </div>
