<div class="sec2-tien-do-pc">
    <div class="position-absolute d-flex justify-content-end align-content-center d-block d-sm-none"
         style="width: 140%; transform: translateX(-29%)">
    ...
    <p class="header2-sec2-tien-do icielbegum d-none d-md-block"
       style="font-size: 2.66vw">{{ __('progress/sec2.title') }}</p>
    <p class="header2-sec2-tien-do icielbegum d-block d-md-none"
       style="font-size: 29px">{{ __('progress/sec2.title') }}</p>
    <form class="row-test" style="padding-bottom: 4%">
        <input class="col-md-3 col-xs-12 input-tien-do shadow-effect border-0 mulish-extrabold px-3"
               style="height: 3rem; font-size: 15px"
...
<div class="secret d-none">
    @foreach($images_tien_do_vi as $image)
