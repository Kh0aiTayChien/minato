<div class="thuvien">
    ...
    <div class=" justify-content-center align-items-center NotoSerifJP   d-none d-sm-flex"
         style="font-size: 51px; color: #141C46">
        {{__('library/sec2.title1')}}
    </div>
    <div class=" d-flex justify-content-center align-items-center NotoSerifJP   d-flex d-sm-none"
    ...
    <div class=" tabs mb-3 pb-3">
        ...
        <div class="row tab tab3 px-5 mt-5 gy-4 gx-0 " style="">
            <div class="col-md-6 col-xs-12">
                <a target="_blank" href="{{asset('images/thuvien/brochure/BROCHURE.pdf')}}">
        ...
        <div class="row tab tab4 flag-brochure mt-5 gy-4 gx-0 " style="">
            <div class="col-md-6 col-xs-12">
                <a target="_blank" href="{{asset('images/thuvien/flyer/Residence.pdf')}}">
