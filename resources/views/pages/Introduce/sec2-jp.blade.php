...
{{--                       style="font-size: 51px; line-height: 10px; padding-bottom: 5%">{{__('introduction/section2.PROJECT')}}</p>--}}
    ...
    <div class="row pt-5">
        ...
        <div class="col-lg-2 col-xs-6">
            <div class="icielbegum yellow-light-color d-flex justify-content-center align-content-center"
                 style="font-size: 73px;">43,29%
            </div>
            <div class="cabin-medium text-white d-flex justify-content-center align-content-center"
                 style="font-size: 16px; letter-spacing: 1px"> {{__('introduction/section2.sub1')}}</div>
        </div>
        <div class="col-lg-2  col-xs-6">
            <div class="icielbegum yellow-light-color d-flex justify-content-center align-content-center"
                 style="font-size: 73px;">1,2
            </div>
            <div class="cabin-medium text-white d-flex justify-content-center align-content-center"
                 style="font-size: 16px; letter-spacing: 1px">{{__('introduction/section2.sub2')}}</div>
        </div>
        <div class="col-lg-2  col-xs-6">
            <div class="icielbegum yellow-light-color d-flex justify-content-center align-content-center"
                 style="font-size: 73px;">02
            </div>
            <div class="cabin-medium text-white d-flex justify-content-center align-content-center"
                 style="font-size: 16px; letter-spacing: 1px">{{__('introduction/section2.sub3')}}</div>
        </div>
        <div class="col-lg-2  col-xs-6">
            <div class="icielbegum yellow-light-color d-flex justify-content-center align-content-center"
                 style="font-size: 73px;">924
            </div>
            <div class="cabin-medium text-white d-flex justify-content-center align-content-center"
                 style="font-size: 16px; letter-spacing: 1px">{{__('introduction/section2.sub4')}}</div>
        </div>
        <div class="col-lg-2  col-xs-12">
            <div class="icielbegum yellow-light-color d-flex justify-content-center align-content-center"
                 style="font-size: 73px;">03
            </div>
            <div class="cabin-medium text-white d-flex justify-content-center align-content-center"
                 style="font-size: 16px; letter-spacing: 1px">{{__('introduction/section2.sub5')}}</div>
        </div>
        <div class="col-1"></div>
    </div>
</div>
