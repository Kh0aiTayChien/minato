<div class="sec3-intro-pc d-none d-sm-block position-relative">
    ...
    <div class="row-test all-header-sec3-intro-pc ">
        <div class="col-11">
            ...
            <p class="header2-sec3-intro-pc NotoSerifJP space-51">和のエッセンスを取り入れた、
            </p>
            <p class="header2-sec3-intro-pc NotoSerifJP space-51" style="margin-top: -1.5%;">日常を謳歌する</p>
...
<div class="sec3-intro-mb d-block d-sm-none">
    ...
    <p class="header-second-line-intro-mb line-height-cap NotoSerifJP pt-1" style="transform: translateX(2%)">
        和のエッセンスを取り入れた、</p>
