<div class="sec5-intro d-none d-sm-block">
    <p class="header1-sec5-intro icielbegum space-51">ĐẲNG CẤP VƯỢT TRỘI</p>
    <p class="header2-sec5-intro icielbegum space-51">Từ chất lượng Nhật Bản</p>
    <div class="row-test-1 content-sec5-intro">
        <div class="left-test-1" style="padding-left: 4%; padding-top: 4%">
        <p class="text-content1-sec2-hp space-15 text-sec5-intro cabin-medium pb-4">The Minato Residence là dự án tiên phong tại Hải Phòng
            hội tụ đủ 100% yếu tố Nhật
