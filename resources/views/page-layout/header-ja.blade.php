...
<div class="menu-dropdown d-none">
    <div class="mobile-menu">
        <div class="text-center"><a href="{{ LaravelLocalization::localizeUrl(route('homepage.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.homepage') }}</a></div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('introduce.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.introduction') }}</a></div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('location.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.location') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('Product.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.product') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('utility.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.utilities') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('news.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.news') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('progress.index'))}}" class="text-menu-mb NotoSerifJP ">{{ __('header.progress') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('library.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.library') }}</a> </div>
        <div class="text-center mt-3"><a href="{{ LaravelLocalization::localizeUrl(route('contact.index')) }}" class="text-menu-mb NotoSerifJP ">{{ __('header.contact') }}</a> </div>
...
<div class="headerpc fixed-top NotoSerifJP  d-none d-sm-block" id="myHeader " >
