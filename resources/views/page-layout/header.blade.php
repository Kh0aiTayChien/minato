...
<div class="menu-dropdown d-none">
    <div class="mobile-menu">
        ...
        <div class="text-center mt-2"><a href="/gioi-thieu">GIỚI THIỆU</a></div>
        <div class="text-center mt-2><a href="/vi-tri">VỊ TRÍ</a> </div>
        <div class="text-center mt-2"><a href="/san-pham">SẢN PHẨM</a> </div>
        <div class="text-center mt-2"><a href="/tien-ich">TIỆN ÍCH</a> </div>
        <div class="text-center mt-2"><a href="/tin-tuc">TIn TỨC</a> </div>
        <div class="text-center mt-2"><a href="/tien-do">TIẾN ĐỘ</a> </div>
        <div class="text-center mt-2"><a href="/thu-vien">THƯ VIỆN</a> </div>
