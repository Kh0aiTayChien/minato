...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <select class="form-select form-control" id="search_type" name="search_type">
                                <option value="title" {{ $searchType === 'title' ? 'selected' : '' }}>Tìm kiếm theo tên</option>
                                <option value="content" {{ $searchType === 'content' ? 'selected' : '' }}>Tìm kiếm theo họ</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-1">
                        ...
                        <select class="form-select form-control " id="paginate" name="paginate">
                            <option value="1" {{ $paginate == 1 ? 'selected' : '' }}>1 tài khoản </option>
                            <option value="2" {{ $paginate == 2 ? 'selected' : '' }}>2 tài khoản </option>
                            <option value="5" {{ $paginate == 5 ? 'selected' : '' }}>5 tài khoản </option>
                        </select>
                    </div>
            ...
            @include('admin/user/index/page',compact('articles'))
        </div>
    </div>
@endsection
